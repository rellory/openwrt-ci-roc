...
sed -i "s/hostname='.*'/hostname='ImmWRT'/g" package/base-files/files/bin/config_generate
...
git clone --depth=1 https://github.com/nikkinikki-org/OpenWrt-momo.git;main package/luci-app-momo
